...
function handleSubmit(e) {
    ...
    if (!nameInp.value) {
        ...
        nameInp.classList.remove('eror')
        nameInp.parentElement.classList.remove('error_mesagge')
    }
    ...
    if (!numberInp.value) {
        ...
        numberInp.classList.remove('eror')
        numberInp.parentElement.classList.remove('error_mesagge')
    }
    ...
    if (!monthInp.value) {
        ...
        monthInp.classList.remove('eror')
        monthInp.parentElement.classList.remove('error_mesagge')
    }
    ...
    if (!yearInp.value) {
        ...
        yearInp.classList.remove('eror')
        yearInp.parentElement.classList.remove('error_mesagge')
    }
    ...
    if (!cvcInp.value) {
        ...
        cvcInp.classList.remove('eror')
        cvcInp.parentElement.classList.remove('error_mesagge')
    }
